...
class Calculator extends WindowAdapter implements ActionListener
{
    ...
    public Calculator(int width, int height, String title)
    {
        ...
        t2 = new TextField();
                   //x,y,Wid, Hei
        b1.setBounds(30,280,80,40);
        b2.setBounds(120,280,80,40);
        b3.setBounds(220,280,80,40);
        b4.setBounds(320,280,80,40);
...
class VynkyCalculator
{
    public static void main(String Arg[])
    {
       Calculator cobj = new Calculator(450,450,"Vynky's Calculator");
